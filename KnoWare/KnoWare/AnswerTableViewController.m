...
#import "AnswerMultiplceChoiceAnswerViewController.h"
#import "AnswerNumericalChoiceViewController.h"
...
- (void)viewDidLoad {
    ...
    self.navigationItem.backBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Answer List" style:UIBarButtonItemStylePlain target:nil action:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([selectedQuery.surveyType isEqualToString:@"multipleChoice"])
        [self performSegueWithIdentifier: @"answerToMultipleChoice" sender: self];
    if([selectedQuery.surveyType isEqualToString:@"numerical"])
        [self performSegueWithIdentifier: @"answerToNumericalChoice" sender: self];
}
...
- (IBAction)homeButtonPressed:(id)sender {
    [self performSegueWithIdentifier:@"answerToHome" sender:self];
}
@end
