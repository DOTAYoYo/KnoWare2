...
@interface ViewMapViewController () <GMSMapViewDelegate>{
...
- (IBAction)homeButtonPressed:(id)sender {
    [self performSegueWithIdentifier:@"viewMapToHome" sender:self];
    
}

- (IBAction)actionButtonPressed:(id)sender {
    if ([selectedQuery.surveyType isEqualToString:@"numerical"]) {
        [self performSegueWithIdentifier:@"viewMapToNumericalChoice" sender:self];
    }
    if ([selectedQuery.surveyType isEqualToString:@"multipleChoice"]) {
        [self performSegueWithIdentifier:@"viewMapToMultipleChoice" sender:self];
    }
