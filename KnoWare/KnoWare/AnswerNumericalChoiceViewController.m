//
//  AnswerNumericalChoiceViewController.m
//  KnoWare
//
...
@interface AnswerNumericalChoiceViewController (){
...
@implementation AnswerNumericalChoiceViewController
...
- (IBAction)homeButtonPressed:(id)sender {
    [self performSegueWithIdentifier:@"answerNumericalToHome" sender:self];
}
