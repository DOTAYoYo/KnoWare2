...
@interface AnswerMultiplceChoiceAnswerViewController ()<NSURLConnectionDelegate>{
...
@implementation AnswerMultiplceChoiceAnswerViewController
...
- (IBAction)homeButtonPressed:(id)sender {
    [self performSegueWithIdentifier:@"answerMultipleToHome" sender:self];
}
